...
- [x] T001: `core/src/repositories/dynamodb-alert.repository.ts` の `getByFrequency` を修正する
...
- [x] T002: `core/src/repositories/dynamodb-alert.repository.ts` の `getByUserId` にも同様のエラー耐性化を適用する
...
- [x] T003: `batch/src/temporary-alert-expiry.ts` の `handler` を修正する
...
- [x] T004: `core/tests/` に `dynamodb-alert.repository` のテストを追加・更新する
...
- [x] T005: `batch/tests/` に `temporary-alert-expiry` のテストを追加・更新する
...
- [x] T006: `npm run lint --workspace=@nagiyu/stock-tracker-core` が通過することを確認する（依存: T001, T002）
- [x] T007: `npm run test --workspace=@nagiyu/stock-tracker-core` が通過することを確認する（依存: T004）
- [x] T008: `npm run build --workspace=@nagiyu/stock-tracker-core` が通過することを確認する（依存: T006, T007）
- [x] T009: `npm run lint --workspace=@nagiyu/stock-tracker-batch` が通過することを確認する（依存: T003）
- [x] T010: `npm run test --workspace=@nagiyu/stock-tracker-batch` が通過することを確認する（依存: T005）
- [x] T011: `npm run build --workspace=@nagiyu/stock-tracker-batch` が通過することを確認する（依存: T009, T010）
