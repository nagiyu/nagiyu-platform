...
export const MEMORY_PAGE_GUIDANCE = '内容を変えたい場合は、ひよりちゃんに話しかけて訂正してね。';
 ...
 */
export const MEMORY_DELETE_ANNOTATION =
  '削除しても、直近の会話や圧縮要約にはすぐ反映されないよ。完全に忘れてほしい場合は、ひよりちゃんに直接話しかけて訂正をお願いしてね。';
