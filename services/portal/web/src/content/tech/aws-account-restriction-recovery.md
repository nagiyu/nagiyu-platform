...
そう判断してしまった理由は 3 つある。どれも、たぶん多くの人が同じように踏む。

**1 つ目は、メールが英語だったこと。** 件名と、キー ID らしき文字列が並んでいるところだけを拾って、読むのを途中で諦めた。

**2 つ目は、1 通ではなく 5〜6 通まとめて届いたこと。** 全部 AWS からだった。他サービスの通知に紛れて埋もれたのではなく、**AWS の通知が AWS の通知の中で埋もれた**。

AWS はこの手の通知を 1 通にまとめてくれない。**漏洩したキーごとにサポートケースが立ち、それぞれについて通知が飛ぶ。** しかも件名が似ている。
...
英語で、似た件名が束で並ぶ。この見た目になると「同じ内容の重複だろう」と処理してしまう。実際に開いたのは 1 通だけで、それも軽く目を通した程度だった。

**3 つ目が、いちばん厄介だった。形式が、ふだん届く他のアナウンス系メールと変わらないこと。**

AWS からは、メンテナンス予告、サービス更新、料金のお知らせといったメールが日常的に届く。**その中に混ざると、見た目では区別がつかない。** 件名の `[Action Required]` も、routine な案内で使われることがある以上、それだけでは緊急性の判別に使えない。私は形式で「いつものやつ」に分類してしまった。

**PC で見ていたことも、良い方向には働かなかった。** 一覧で束をまとめて見渡せてしまうぶん、1 通ずつ開かずに、並びの印象だけで処理できてしまう。スマホで 1 通ずつ押し開けていたら、逆に本文まで届いていたかもしれない。

これが最初の判断ミスだった。本文には、やるべきことが Step 1 から Step 4 まで明記されていて、対応期限も書かれていた。**そして「アカウントに制限をかけた」ことも書かれていた。** 読んでいれば、本番が止まっていることはこの時点で分かった。

件数が多いことは、深刻度が低い証拠ではない。**むしろ逆で、件数はそのまま「漏洩したキーの本数」を意味していた。**

見分ける手がかりは、件名にも見た目にも無い。**本文に Step 1〜4 の手順と対応期限が書かれていたら、それはアナウンスではなく、こちらが動かないと止まったままになるやつだ。** 束で届いたら、開くのは 1 通ではなく全部にしたほうがいい。
...
- **初動の遅れ（約 1 日）**: 通知は届いていた。英語だったので読むのを途中で諦め、深刻度を低く見積もった。実際に動いたのは、自分でサービスを触って壊れていることに気づいてからだった
