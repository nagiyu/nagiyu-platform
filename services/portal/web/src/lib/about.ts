...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  {
    ...
    title: '技術記事の執筆を開始',
    description:
      'AWS・TypeScript などの実装経験をもとに技術記事の執筆を開始。個人開発のインフラ構成や運用で実際に手を動かして得た知見を記録し始めた。',
  },
  {
    period: '2026年5月',
  ...
  {
    period: '2026年7月〜',
    title: '記事の方針を「量」から「一次体験」へ切り替え',
    description:
      'AI に下書きさせて本数を増やす書き方では、自分にしか語れないことが入らないと判断。既存記事を 1 本ずつ棚卸しし、実際に自分が踏んだ失敗や下した判断を語れるものだけを残して大幅に削減した。以降は、AI を生成器ではなく「記憶を掘るインタビュアー」として使う書き方に切り替えている。',
  },
] as const;
...
export const TARGET_READERS: string[] = [
  '個人・小規模で AWS 上のサービスを運用しているエンジニア',
