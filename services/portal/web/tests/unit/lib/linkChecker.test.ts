...
describe('linkChecker', () => {
  ...
  describe('staticPageExists', () => {
    ...
    it('/services は STATIC_ROUTES に含まれず false を返す', () => {
      // /services は実在ルートではない（STATIC_ROUTES にも src/app/services にも無い）
