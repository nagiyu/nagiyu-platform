...
| E2E-011    | JSON 整形 - 基本操作           | 入力 → 整形/圧縮/検証 → 出力の基本操作         | 高     | 全デバイス   |
| E2E-012    | Base64 - 基本操作              | テキスト入力 → エンコード/デコード → 出力の基本操作 | 中     | 全デバイス   |
| E2E-013    | URL エンコーダー - 基本操作    | テキスト入力 → エンコード/デコード → 出力の基本操作 | 中     | 全デバイス   |
| E2E-014    | ハッシュ生成 - 基本操作        | テキスト入力 → SHA-256/SHA-512 ハッシュ生成 → Hex 出力の基本操作 | 中     | 全デバイス   |
| E2E-015    | VAPID キー生成 - 基本操作      | キー生成ボタン押下 → 公開鍵/秘密鍵表示の基本操作 | 低     | 全デバイス   |
| E2E-016    | タイムスタンプ変換 - 基本操作  | Unix タイムスタンプ入力 → 日時変換の基本操作   | 中     | 全デバイス   |
