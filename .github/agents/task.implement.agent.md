...
2. **現在のフェーズとタスクの特定**:
    - Issue 本文・サブ Issue から現在のフェーズと未完了タスクを確認
...
3. **実装ワークフロー**:
    ...
    Phase 3: 検証とデプロイ
    3a. Issue 本文・サブ Issue のチェックリストを更新
...
1. **タスク進捗更新**:
    - Issue 本文・サブ Issue で完了タスクを `[x]` としてマーク
    - 必要に応じてステータスと日付を更新
    - ドキュメントを実際の進捗と同期
