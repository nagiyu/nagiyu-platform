...
このディレクトリには、CloudFormation から CDK への移行を支援する共通ユーティリティが含まれています。
...
- [CDK 移行ガイド](../../../../docs/infra/cdk-migration.md) - CloudFormation から CDK への移行戦略
- [インフラアーキテクチャ](../../../../docs/infra/root/architecture.md) - インフラ全体の設計
